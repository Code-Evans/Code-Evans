...
- **Software Engineer (Data Analytics & AI Solution)**
...
- **Website Chatbot feature** — Designed and built an AI-powered chatbot using AWS Bedrock, adaptable for integration across portfolio websites.
